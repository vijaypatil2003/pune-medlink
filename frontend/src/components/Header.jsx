...
const Header = () => {
  return (
    <div className="flex flex-col md:flex-row items-center justify-between px-6 md:px-12 bg-[#5f6FFF]">
      ...
      <div className="md:w-1/2 flex justify-center">
        <img src={assets.header_img} alt="header" className="w-[80%] md:w-full" />
      </div>
