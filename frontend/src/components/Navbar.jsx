      ...
      <div className='flex items-center gap-4'>
        {
          token
            ? (
              <div
                className='flex items-center gap-2 cursor-pointer relative md:group'
                onClick={() => setOpenMenu(!openMenu)}   // CLICK for mobile
              >
                ...
                <div
                  className={`
                    ...
                    ${openMenu ? "block" : "hidden"}     /* MOBILE CLICK */
                    md:group-hover:block                 /* DESKTOP HOVER */
                  `}
                >
